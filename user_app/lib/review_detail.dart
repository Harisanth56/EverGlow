...
class _Theme {
  ...
  static const cardBorder = Colors.white12;
  static const purpleAccent = Color(0xFF8E71FF);
  static const amber = Colors.yellow;
  static const textPrimary = Colors.white;
  static const textSecondary = Colors.white38;
  static const textMuted = Colors.white12;
        ...
        children: [
          SizedBox(
            ...
            child: CircularProgressIndicator(
              strokeWidth: 2,
              valueColor: AlwaysStoppedAnimation(_Theme.purpleAccent),
            ),
          ),
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _Theme.purpleAccent.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                          color: _Theme.purpleAccent.withOpacity(0.3),
                          width: 0.5,
                        ),
                      ),
                      child: Text(
                            ...
                            children: [
                              ...
                              FractionallySizedBox(
                                ...
                                child: Container(
                                  height: 6,
                                  decoration: BoxDecoration(
                                    gradient: starLevel >= 3
                                        ? _Theme.scoreGradient
                                        : LinearGradient(
                                            colors: [
                                              Colors.redAccent,
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, imgIdx) {
                    final String imageUrl = rating.attachmentUrls[imgIdx];
  ...
  Widget _buildAvatar(String photoUrl, String name) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: _Theme.purpleAccent.withOpacity(0.25),
            blurRadius: 10,
            spreadRadius: 1,
          ),
        ],
...
void _openFullScreenImage(BuildContext context, String imageUrl) {
    showDialog(
      ...
      barrierColor: Colors.black45, // Deep dark overlay background
      builder: (context) {
        return Stack(
          children: [
            // Interactive view allowing panning & pinch-to-zoom mechanics
            Center(
            ...
            // Floating Close button on top-right edge
            SafeArea(
              child: Align(
