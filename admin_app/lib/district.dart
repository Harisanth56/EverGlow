...
class _DistrictState extends State<District> {
  ...
  Future<void> insert() async {
    final text = districtController.text.trim();
    if (text.isEmpty) {
      _showSnackBar('Please enter a district name', isError: true);
      return;
    }
    try {
      await supabase.from('tbl_district').insert({'district_name': text});
      _showSnackBar('District "$text" Added Successfully');
      districtController.clear();
      fetchDistricts();
    } catch (e) {
      _showSnackBar('Error adding district', isError: true);
    }
  }
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(
              "Configure geographical operational zones for JosKart",
              style: TextStyle(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              await supabase
                  .from('tbl_district')
                  .update({'district_name': editController.text.trim()})
                  .eq('district_id', data['district_id']);
